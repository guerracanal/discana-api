...
class ParametersValues:
    ...
    DURATION = f'<{INT}{Parameters.DURATION}>'
    DURATION_MIN = f'<{INT}{Parameters.DURATION_MIN}>'
    DURATION_MAX = f'<{INT}{Parameters.DURATION_MAX}>'
    LABEL = f'<{Parameters.LABEL}>'
    TRACKS = f'<{INT}{Parameters.TRACKS}>'
...
class Routes:
    ...
    DURATION = f'{Parameters.DURATION}/{ParametersValues.DURATION_MIN}/{ParametersValues.DURATION_MAX}'
    DURATION_MIN = f'{Parameters.DURATION_MIN}/{ParametersValues.DURATION_MIN}'
    DURATION_MAX = f'{Parameters.DURATION_MAX}/{ParametersValues.DURATION_MAX}'
    LABEL = f'{Parameters.LABEL}/{ParametersValues.LABEL}'
    TRACKS = f'{Parameters.TRACKS}/{ParametersValues.TRACKS}'
